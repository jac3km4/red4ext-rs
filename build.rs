...
fn main() {
    ...
    let impl_partialeq = r#"
/* automatically generated by build.rs */

impl<T> ::std::cmp::PartialEq for crate::red::SharedPtrBase<T> {
    #[inline]
    fn eq(&self, other: &crate::red::SharedPtrBase<T>) -> bool {
        if self.instance.is_null() || other.instance.is_null() {
            return false;
        }
    ...
    let mut file = std::fs::OpenOptions::new()
        ...
        .expect("Bindings file should have already been generated.");
    if let Err(e) = write!(file, "{impl_partialeq}") {
        println!("cargo:error=Couldn't write PartialEq impl to file: {e}");
    }
